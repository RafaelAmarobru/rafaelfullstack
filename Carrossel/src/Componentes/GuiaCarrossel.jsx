 ...
 * GuiaCarrossel.jsx
 *
 * Guia rápido para personalização do Carrossel
 *
 * Objetivo:
 * Ajudar o aluno a localizar rapidamente a classe CSS
 * responsável por cada alteração visual.
 *
 ***********************************************************************/
...
export default function GuiaCarrossel() {
    ...
    return (
        ...
        <section className="guia">
            ...
            <p>
                Consulte a tabela abaixo para saber em qual classe CSS
                realizar cada alteração.
            </p>
            ...
            <table className="tabelaGuia">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Tamanho do Título</td>
                        <td>.texto h2</td>
                        <td>font-size:34px;</td>
                    </tr>
